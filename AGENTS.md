...
- Model toggles: `-Denable-<model>=false` (gemma3, gemma4, diffusion-gemma, qwen35, qwen4exp, gpt-oss, nemotron-h, nemotron-nano, glm4, deepseek4, llama4).
...
Supports 6 backends (Metal, CUDA, Vulkan, ROCm, WebGPU, CPU), 11 model architectures (Gemma3/4, DiffusionGemma, Qwen3.5/Nex-N2-Pro, Qwen 3.8 Flash-Next, GPT-OSS, Nemotron-H/Nano, GLM-4, DeepSeek V4, Llama 4), and extensive quantization (Q2-Q8, FP8, bf16, NVFP4, MXFP4, MLX, TurboQuant KV). Megakernel system with composable building blocks for fused GPU dispatch. CLI and HTTP server interfaces. Built with Zig 0.16.0. Zero external dependencies.
