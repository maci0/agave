...
17. [Speculative Decoding & DDTree](tutorial/17-speculative-decoding.md) — 11 modes: DDTree, self-spec, n-gram, suffix, lookahead, EAGLE, MLP Speculator, Medusa, MTP, FR-Spec, shared pools
