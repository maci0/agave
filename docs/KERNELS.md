...
**Pipeline/kernel counts**: Metal 70+ pipelines (+ 1 runtime-composed), CUDA 54 kernels, ROCm 42 kernels, Vulkan 42 shaders, WebGPU 43 shaders. Total megakernel code: ~4,166 lines across 12 files plus ~780 lines in `mega_compose.zig` (composable generator).
