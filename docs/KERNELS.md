...
| Metal | `src/backend/kernels/metal/` | `common.metal`, `elementwise.metal` (incl. `copy_f32`), `norm.metal`, `rope.metal` (incl. `rope_batched_f32`), `gemv.metal`, `gemv_tiled.metal` (Q4_K/Q8_0 tiled), `gemm.metal` (f32/Q8_0/Q4_0/BF16), `sdpa.metal` (incl. `sdpa_prefill_fa2`), `sdpa_tree.metal` (DDTree), `deltanet.metal`, `ds4.metal` + `ds4_fused.metal` (14 DeepSeek V4 kernels: HC weights/pre/post/head, RoPE/invRoPE table, emb broadcast, weighted accum, turbo SDPA hd512, fused attn proj, top-k routing, MoE gate+up/down MXFP4, RMS no-weight), `megakernel.metal` (13 fused FFN kernels: SiLU x {Q8_0, Q4_K, Q5_K, Q6_K, Q4_0, MLX_Q4} + GELU x {Q8_0, Q4_K, Q5_K, Q6_K, Q4_0} + clamped SiLU x {Q2_K, MXFP4}), `mega_common.metal` (18 composable building blocks, 752 lines), `mega_qwen35_q8.metal`, `mega_qwen35_q4k.metal`, `mega_gemma_q4k.metal`, `mega_gemma_q8.metal`, `mega_nemotron_h_q8.metal` (true megakernels) |
